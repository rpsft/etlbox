...
namespace EtlBox.Database.Tests.Logging.Database
{
    ...
    public abstract class GetLogAsJsonTests : DatabaseTestBase, IDisposable
    {
            ...
            ITestOutputHelper logger) : base(fixture, connectionType, logger)
        {
            ...
            ALE.ETLBox.Common.ControlFlow.ControlFlow.DefaultDbConnection = _connectionManager;
        }
        ...
        {
            DropTableTask.Drop(_connectionManager, ALE.ETLBox.Common.ControlFlow.ControlFlow.LogTable);
            DropTableTask.Drop(_connectionManager, ALE.ETLBox.Common.ControlFlow.ControlFlow.LoadProcessTable);
