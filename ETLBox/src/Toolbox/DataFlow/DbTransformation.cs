...
{
    public class DbTransformation<TInput>: RowTransformation<TInput>
    {
        /* Public properties */
        /// <summary>
        ...
        public DbTransformation()
        {
            ...
            {
                PrepareWrite();
                TryBulkInsertData(source);
                return source;
            };
        }

        public DbTransformation(string tableName)
            : this()
        {
            TableName = tableName;
            InitObjects();
        ...
        public DbTransformation(IConnectionManager connectionManager, string tableName)
            : this(tableName)
        {
        ...
        protected void TryBulkInsertData(params TInput[] data)
        {
