...
namespace ALE.ETLBox.Serialization
{
    ...
    /// - Initialize from XML using <see cref="System.Xml.Serialization.XmlSerializer.Deserialize"/>
    ...
    {
        /// <summary>
        /// Get or add connection manager to the pool.
        /// </summary>
        /// <remarks>
        /// Data flow implementation owns resources for the connection manager and will dispose it when data flow is completed.
        /// Use this method to get or add connection manager to the pool, so that other components can use it.
        /// </remarks>
        /// <param name="connectionManagerType">Connection manager type. Must implement IConnectionManager</param>
        /// <param name="key">Unique identifier of connection manager in the pool, like connection string</param>
